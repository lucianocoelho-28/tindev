...
<p align="center">
  <img alt="GitHub language count" src="https://img.shields.io/github/languages/count/lucianocoelho-28/tindev">

  <img alt="Repository size" src="https://img.shields.io/github/repo-size/lucianocoelho-28/tindev">
  
  <a href="https://github.com/lucianocoelho-28/tindev/commits/main">
    <img alt="GitHub last commit" src="https://img.shields.io/github/last-commit/lucianocoelho-28/tindev">
  </a>

  <a href="https://github.com/lucianocoelho-28/tindev/issues">
    <img alt="Repository issues" src="https://img.shields.io/github/issues/lucianocoelho-28/tindev">
  </a>
...
Podemos classificar como a parte visual de um site, aquilo que conseguimos interagir. Quem trabalha com Front End é responsável por desenvolver por meio do código uma interface gráfica e, normalmente, com as tecnologias base da Web: **_HTML_**, **_CSS_** e **_JavaScript_**.
